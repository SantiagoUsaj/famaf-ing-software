...
class Figures(Base):
    ...
    def create_figures():
        if session.query(Figures).count() == 0:
            figures_data = [
                ("01,02,01,11", "00,01,11,12", "00,10,11,12", "10,20,01,11"),
                ("00,10,01,11", "00,10,01,11", "00,10,01,11", "00,10,01,11"),
                ("00,10,11,21", "00,10,11,21", "10,01,11,02", "10,01,11,02"),
                ("00,10,20,11", "00,01,02,11", "10,01,11,12", "10,11,01,21"),
                ("11,21,31,30", "00,10,20,21", "00,01,02,10", "00,01,11,21"),
                ("10,20,30,40", "00,01,02,03", "10,20,30,40", "00,01,02,03"),
                ("00,01,02,12", "01,11,21,20", "00,10,11,12", "00,10,20,01"),
                ("20,12,11,10,00", "21,11,20,10,00", "22,12,02,11,10", "22,21,11,01,20"),
                ("31,21,11,10,00", "30,20,10,11,01", "03,12,02,11,10", "31,21,20,10,00"),
                ("24,23,13,12,11", "30,20,21,11,01", "13,12,11,01,00", "30,20,10,11,01"),
                ("20,10,11,02,01", "22,12,11,01,00", "20,21,11,12,02", "22,21,11,10,00"),
                ("40,30,20,10,00", "04,03,02,01,00", "40,30,20,10,00", "04,03,02,01,00"),
                ("20,10,02,01,00", "22,12,02,01,00", "02,12,22,21,20", "22,21,20,10,00"),
                ("10,11,12,13,03", "31,30,20,10,00", "10,03,02,01,00", "31,21,11,01,00"),
                ("13,03,02,01,00", "30,31,21,11,01", "13,12,11,10,00", "22,12,11,10,01"),
                ("20,21,12,11,01", "12,21,11,10,00", "21,11,10,02,01", "21,11,10,02,01"),
                ("22,12,11,10,00", "20,21,11,02,01", "22,12,11,10,00", "20,21,11,02,01"),
                ("20,12,11,10,01", "21,12,11,01,00", "21,10,11,12,02", "22,21,10,11,01"),
                ("20,10,11,12,02", "22,01,11,01,00", "20,10,11,12,02", "22,01,11,01,00"),
                ("02,13,12,11,10", "21,30,20,10,00", "11,03,02,01,00", "10,31,21,11,01"),
                ("12,03,02,01,00", "20,31,21,11,01", "13,12,10,11,01", "11,30,20,10,00"),
                ("12,11,02,01,00", "10,20,21,11,01", "01,12,11,10,00", "01,11,20,10,00"),
                ("12,02,01,10,00", "20,21,11,01,00", "02,12,11,10,00", "21,20,10,01,00"),
                ("21,12,10,11,01", "21,12,10,11,01", "21,12,10,11,01", "21,12,10,11,01"),
                ("10,11,12,02,01", "11,21,20,10,00", "02,01,11,10,00", "01,21,11,10,00")
            ]
