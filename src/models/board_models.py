    ...
    def create_figures():
        if session.query(Figures).count() == 0:
            figures_data = [
                ...
                ("11,21,31,30", "00,10,20,21", "00,01,02,10", "00,01,11,21"),                       # 5
                ("10,20,30,40", "00,01,02,03", "10,20,30,40", "00,01,02,03"),                       # 6
                ("00,01,02,12", "01,11,21,20", "00,10,11,12", "00,10,20,01"),                       # 7
                ("20,12,11,10,00", "21,11,20,10,00", "22,12,02,11,10", "22,21,11,01,20"),           # 8
                ...
                ("13,03,02,01,00", "30,31,21,11,01", "13,12,11,10,00", "22,12,11,10,01"),           # 15
                ("20,21,12,11,01", "12,21,11,10,00", "21,11,10,02,01", "21,11,10,02,01"),           # 16
                ("22,12,11,10,00", "20,21,11,02,01", "22,12,11,10,00", "20,21,11,02,01"),           # 17
